package coreUtility.AbstractComponent;

import coreUtility.Actions.VeevaActions;
import coreUtility.Exceptions.PageNotLoadedException;
...
public abstract class AbstractPage extends VeevaActions {
    ...
    protected Duration defaultTimeout = Duration.ofSeconds(Long.parseLong(getGlobalConfigData().get("timeOut").toString()));
