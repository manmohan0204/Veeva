package coreUtility.TestComponent;

import coreUtility.FileUtility.FileUtiltyClass;
import coreUtility.Logger.VeevaLog;
import coreUtility.Logger.VeevaLog.VeevaLogLevel;
...
public class VeevaBase {
    ...
    static String Test_CONFIG_FILE =
            System.getProperty("user.dir") + File.separator + "src"
                    + File.separator + "test" + File.separator + "resources" + File.separator + "testConfig.json";
    ...
    public static HashMap<String, Object> getTestConfigData() throws IOException {
        return FileUtiltyClass.getJsonDataToMap(Test_CONFIG_FILE);
    }
    ...
    public void setUpTest(String browser) throws Exception {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(Integer.parseInt(getGlobalConfigData().get("timeOut").toString())));
